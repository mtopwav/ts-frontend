            ...
            <form onSubmit={handleSubmit} className="manager-expense-form">
              <div className="form-row">
                <div className="form-field">
                  <label htmlFor="boma-expense-date">{t.expenseDate || 'Expense Date'} *</label>
                  <input
                ...
                <div className="form-field">
                  <label htmlFor="boma-expense-category">{t.expenseCategory || 'Category'} *</label>
                  <select
              ...
              <div className="form-row">
                <div className="form-field">
                  <label htmlFor="boma-expense-amount">{t.expenseAmount || 'Amount'} (TZS) *</label>
                  <input
                ...
                <div className="form-field">
                  <label htmlFor="boma-expense-status">{t.status || 'Status'}</label>
                  <select
