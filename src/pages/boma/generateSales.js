  ...
  return (
    <div className="payments-container boma-portal">
      ...
      <div className="main-content">
        <BomaPageHeader
          title={bomaLabels.pageTitles.generateSales}
          user={user}
        ...
        <div className="payments-content boma-generate-sales-page">
          <div className="boma-generate-sales-card">
            <div className="card-header">
              <h2>{bomaLabels.pageTitles.generateSales}</h2>
                ...
                <form onSubmit={handleGenerateSale} className="boma-generate-form">
                  <section className="boma-generate-section form-row-full" aria-label="Sale options">
                    ...
                    <div className="boma-generate-row">
                      <div className="form-field">
                        <label className="form-label" htmlFor="boma-payment-type">
                          {t.paymentType || 'Payment Type'} <span className="required">*</span>
                        </label>
                        <select
                          id="boma-payment-type"
                      ...
                      <div className="form-field">
                        <label className="form-label" htmlFor="boma-total-amount">
                          {t.totalAmount}
                        </label>
                        <input
                          id="boma-total-amount"
                          type="text"
                  ...
                  <section className="boma-generate-section form-row-full" aria-label="Customer">
                    ...
                    <div className="boma-generate-row">
                      ...
                      <div className="form-field">
                        <label className="form-label" htmlFor="boma-customer-phone">
                          {t.phone}
                        </label>
                        <input
                          id="boma-customer-phone"
                          type="text"
