...
function ManagerCustomersInfo() {
  ...
  useEffect(() => {
    const loadCustomers = async () => {
      try {
        const response = await getCustomers(BRANCH_BOMA);
  ...
  return (
    <div className="payments-container boma-portal">
      ...
      <div className="main-content">
        <BomaPageHeader
          title={bomaLabels.pageTitles.customerInfo}
          user={user}
          ...
          <div className="manager-modal-content manager-customer-modal" onClick={(e) => e.stopPropagation()}>
            <div className="manager-modal-header manager-customer-modal-header">
              <div className="manager-customer-modal-title">
                ...
                <div>
                  <h3>{t.addCustomer}</h3>
                  <p className="manager-customer-modal-subtitle">Register a new customer for Boma Branch</p>
                </div>
              </div>
