...
function ManagerDashboard() {
  ...
  useEffect(() => {
    const loadPayments = async () => {
      try {
        const res = await getPayments({ location: BRANCH_GEITA });
  ...
  const quickLinks = [
    { to: '/geita/transactions', label: t.transactions, desc: t.reviewApproveTransactions },
    { to: '/geita/loans', label: t.loans, desc: t.manageLoanApprovals },
    { to: '/geita/sales', label: t.sales, desc: t.salesOverview },
    { to: '/geita/spareparts', label: t.spareParts, desc: t.viewInventoryStock },
    { to: '/geita/reports', label: t.reports, desc: t.viewReportsAnalytics },
  ];
  ...
  return (
    <div className="payments-container geita-portal">
      ...
      <div className="main-content">
        <GeitaPageHeader
          title={geitaLabels.pageTitles.dashboard}
          user={user}
        ...
        <div className="payments-content manager-dashboard-content">
          ...
          <section className="manager-transactions-section">
            <div className="manager-section-header">
              ...
              <Link to="/geita/transactions" className="manager-view-all-link">
                {t.viewAll}
              </Link>
            </div>
