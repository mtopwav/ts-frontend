        ...
        <body>
          <div class="tax-inv-top">
            ...
            <div class="tax-inv-meta">
              ...
              <p><strong>Printed by:</strong> ${String(geitaUserName(user)).replace(/</g, '&lt;')}</p>
            </div>
          </div>

          <h1 class="tax-inv-title">${geitaLabels.transactionsReportTitle}</h1>
    ...
    if (activeReport === 'sales') {
      ...
      <html>
        ...
        <body>
          ...
          <h1 class="tax-inv-title">${geitaLabels.salesReportTitle}</h1>
  ...
  return (
    <div className="payments-container geita-portal">
      ...
      <div className="main-content">
        <GeitaPageHeader
          title={geitaLabels.pageTitles.reports}
          user={user}
